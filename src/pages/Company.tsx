          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
              <motion.div className="lg:w-1/2" variants={itemVariants}>
                <h2
                  className={`text-3xl md:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-${jisBlue} from-emerald-400 via-cyan-400 to-blue-500
`}
                >
                  Our Story
                </h2>
        ...
        <motion.section
          ...
          viewport={{ once: true, amount: 0.1 }}
        >
          <div className="container mx-auto px-4 from-emerald-400 via-cyan-400 to-blue-500">
            <motion.h2
              className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 from-emerald-400 via-cyan-400 to-blue-500
"
              variants={itemVariants}
            >
              Our Core Values
        ...
        >
          <div className="container mx-auto px-4">
            <motion.h2
              className="text-3xl md:text-4xl font-bold text-center mb-4 from-emerald-400 via-cyan-400 to-blue-500
"
              variants={itemVariants}
            >
